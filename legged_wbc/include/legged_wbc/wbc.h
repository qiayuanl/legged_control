...
public:
  ...
  vector_t update(const vector_t& state_desired, const vector_t& input_desired, vector_t& rbd_state_measured,
                  size_t mode);
...
private:
  ...
  vector_t state_desired_, input_desired_, q_measured_, v_measured_;
  matrix_t j_, dj_;
